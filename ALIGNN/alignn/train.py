...
def train_dgl(
    ...
    ############## Added by Ashish to pick the best validation model to be used for testing #################
    ...
    best_val_ckpt = torch.load(os.path.join(config.output_dir, best_pt_file), map_location=device)
