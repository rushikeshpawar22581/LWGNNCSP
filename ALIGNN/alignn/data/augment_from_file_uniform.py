...
def write_structs(low, high, scale, num_per, input_dir, output_dir):
    ...
    for cif in cif_files:
        ...
        for i in range(num_per):
            ...
            E.append(['{}_per{}.cif'.format(curr_ind, i+1), curr_form_e])
