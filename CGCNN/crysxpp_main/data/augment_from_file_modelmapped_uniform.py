...
if __name__ == "__main__":
    ...
    output_dir = intermediate_dir + 'modelmapped' + 'bynopretrainingoptimizedcgcnnM1withadam'
    modelpath = '../model/model_best_nopretrainingtrain132krelaxedtrain0.7val0.15test0.15epochs1000lr0.02lrmilestone800optimadamnconv4trial3.pth.tar'
